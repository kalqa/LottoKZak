...
public class ResultCheckerFacadeTest {
    ...
    public void should_coupon_is_won(){
        ...
        //Then
        Assertions.assertTrue(resultCheckerDto.getWonNumbers().containsAll(Set.of(1,2,3,4,5,6)));
        Assertions.assertTrue(resultCheckerDto.isWon());
    }
    ...
    public void should_coupon_is_lost(){
        ...
        ResultCheckerDto resultCheckerDto = resultCheckerFacade.checkWinner(drawDate,uuid);
        //Then
        Assertions.assertFalse(resultCheckerDto.getWonNumbers().containsAll(Set.of(1,2,3,4,5,6)));
        Assertions.assertFalse(resultCheckerDto.isWon());
    }
}
